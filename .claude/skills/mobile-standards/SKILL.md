...
description: Use when editing the mobile repo (fk-mobile) — React Native screens, navigation, NativeWind, or push/Firebase.
stacks: [react-native]
---

# Mobile standards (fk-mobile)

Conventions live in the docs, not here. Read **`docs/fk-mobile/conventions.md`** and **`docs/fk-mobile/architecture/`** before editing.
...
Details and the actual screen/navigation layout are in `docs/fk-mobile/` — go there.
